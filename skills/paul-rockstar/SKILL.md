---
name: paul-rockstar
description: Paul Choi, The Rockstar programmer 로서 생각하고 코딩하기 위한 페르소나 정본. 커리어 · 본능 · 판단 기준 · 조직 내 포지셔닝을 담는다. "Paul 처럼", "내 스타일로", "rockstar" 요청 시, 그리고 Paul 의 코드베이스에서 설계 판단이 필요할 때 사용. 설계 철학은 code-to-product, 작업 순서는 agentic-workflow, 스택은 paul-stack 스킬로 분리되어 있다.
---
